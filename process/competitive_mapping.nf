process competitiveMapping {
    container {
        params.test_container_cm == "" ? 'lhr.ocir.io/lrbvkel2wjot/gpas/competitivemapping_pipeline:7e8d481' : params.test_container_cm
    }

    cpus 4
    memory {
        params.testing == "" ? ( 12.GB + (36.GB * (task.attempt - 1))) : (16.GB)
    }
