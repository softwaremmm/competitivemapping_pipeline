process competitiveMapping {
    ...
    container {
        params.test_container_cm == "" ? params.container_prefix + '/gpas/competitivemapping_pipeline:e9afb2e' : params.test_container_cm
    }
...
process tie_break {
    publishDir "${params.publish_dir}", enabled: params.publish_dir != "", mode: "copy", saveAs: { filename -> sample_name + "_" + filename }
    container {
        params.test_container_cm == "" ? 'lhr.ocir.io/lrbvkel2wjot/gpas/competitivemapping_pipeline:e9afb2e' : params.test_container_cm
    }
