...
process competitiveMapping {
    container = {
        params.test_container=="" ? 'lhr.ocir.io/lrbvkel2wjot/gpas/competitivemapping_pipeline:1.2.1' : params.test_container
    }

    cpus = 8
    memory = {
        params.testing=="" ? "48GB" : "32GB"
    }
...
process has_enough_reads {
    container 'lhr.ocir.io/lrbvkel2wjot/gpas/competitivemapping_pipeline:1.2.1'
